...
"""
운영 모드로 Dash 앱 실행
자동 리로드가 비활성화되고 성능이 최적화된 상태로 실행됩니다.
"""
...
# 운영 환경 설정 파일 지정
os.environ['DASH_CONFIG_FILE'] = 'config.production.env'
...
if __name__ == "__main__":
    ...
    app_logger = get_logger(f"prod_startup_{startup_timestamp}")
    ...
    # 시작 정보 로그 기록
    app_logger.info("🚀 운영 모드로 Dash 앱을 시작합니다...")
    app_logger.info(f"📁 설정 파일: config.production.env")
    app_logger.info(f"❌ 자동 리로드: 비활성화")
    app_logger.info(f"❌ 개발 도구: 비활성화")
    app_logger.info(f"⚡ 성능 최적화: 활성화")
    app_logger.info(f"🔇 HTTP 요청 로그: 비활성화")
    app_logger.info(f"⏰ 시작 시간: {startup_timestamp}")
    app_logger.info(f"📄 통합 로그 파일: {unified_log_file}")

    print("🚀 운영 모드로 Dash 앱을 시작합니다...")
    print("📁 설정 파일: config.production.env")
    print("❌ 자동 리로드: 비활성화")
    print("❌ 개발 도구: 비활성화")
    print("⚡ 성능 최적화: 활성화")
    ...
    try:
        ...
        app_logger.info("�� 운영 모드 Dash 앱 종료")
